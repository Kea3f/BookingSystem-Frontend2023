document.write(`
    ...
    <div id="navbarbuttons">
        ...
        <button class="navbar-button booking-button" onclick="location.href='../templates/selecttreatments.html'">Booking</button>
        ...
        <div id="instagram">
            <button id="instagrambtn">
                <a href="https://www.instagram.com/lashesbybiran/" target="_blank">
                    <i class="fab fa-instagram" style="color: #000000; font-size: 32px;"></i>
                </a>
            </button>
        </div>
